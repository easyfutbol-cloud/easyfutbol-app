...
const legalSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'En el caso de un EasyPass ya canjeado para reservar plaza en un partido, se devolverá dicho EasyPass si la cancelación de la plaza se realiza con más de 8 horas de antelación respecto al inicio del partido.',
      'La plaza también puede cancelarse con 8 horas o menos de antelación, pero el EasyPass canjeado no será devuelto. Si el jugador no se presenta, tampoco tendrá derecho a devolución.',
