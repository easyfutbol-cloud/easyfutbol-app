...
import adminCompetitive from './routes/adminCompetitive.js';
...
import { startCompetitiveScoringScheduler } from './services/competitiveScoringService.js';
...
app.use('/api/competitive', competitive);
app.use('/api/admin/competitive', adminCompetitive);
...
(async () => {
  try {
    ...
    app.listen(PORT, () => {
      ...
      startCompetitiveScoringScheduler();
    });
  } catch (e) {
